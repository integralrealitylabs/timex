defmodule Timex.Format.DateTime.Formatter do
  ...
  def format!(date, format_string, formatter),
    do: lformat!(date, format_string, "en", formatter)
  ...
  def format(datetime, format_string, :strftime),
    do: lformat(datetime, format_string, "en", Strftime)
  def format(datetime, format_string, :relative),
    do: lformat(datetime, format_string, "en", Relative)
  def format(datetime, format_string, formatter),
    do: lformat(datetime, format_string, "en", formatter)
  ...
  """
  @spec format_token(atom, Types.calendar_types, list(), list(), list()) :: String.t | {:error, term}
  def format_token(token, date, modifiers, flags, width) do
    format_token("en", token, date, modifiers, flags, width)
  end
  ...
  """
  @spec format_token(String.t, atom, Types.calendar_types, list(), list(), list()) :: String.t | {:error, term}
  ...
  def format_token(_locale, :zabbr, _date, _modifiers, _flags, _width),
    do: ""
  def format_token(_locale, :zoffs, %{std_offset: std, utc_offset: utc}, _modifiers, flags, _width) do
    case get_in(flags, [:padding]) do
